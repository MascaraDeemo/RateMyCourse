...
@EnableJpaRepositories(basePackages = { "usyd.elec5619.ratemycourse" })
@ComponentScan({ "usyd.elec5619.ratemycourse.domain" })
public class HibernateSearchConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "usyd.elec5619.ratemycourse.domain" });
